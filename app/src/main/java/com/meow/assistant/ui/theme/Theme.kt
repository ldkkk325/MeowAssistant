package com.meow.assistant.ui.theme
...
fun MeowAssistantTheme(
    ...
    when (uiMode) {
        UiMode.Miuix -> MiuixAssistantTheme(
            appSettings = appSettings,
            content = content
        )

        UiMode.Material -> MaterialAssistantTheme(
            appSettings = appSettings,
            content = content
        )
    }
...
val LocalEnableGlassSwitch = staticCompositionLocalOf { true }
